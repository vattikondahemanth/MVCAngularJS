...
namespace AngularJSCRUD.Controllers
{
	public class HomeController : Controller
	{
		...
		public ActionResult Index()
		{
			...
			client.BaseAddress = new System.Uri("http://localhost:53157/");
			HttpResponseMessage response = client.PostAsJsonAsync(
			   "api/Home/SearchReportManager", new { UserId = "123", RoleId="test" }).Result;
			var testresult = response.Content.ReadAsAsync<object>().Result;
